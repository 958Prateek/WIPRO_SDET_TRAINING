...
const user = {
    ...
    age: 25,
    role: Role.User,
    email: "prateek@gmail.com.com"
};
const admin = {
    id: 2,
    name: "India",
    age: 30,
    email: "india@gmail.com.com",
    role: Role.Admin,
    isAdmin: true
};
...
names.addItems("Prateek");
names.addItems("India");
...
logLength("Prateek"); // string --> length
logLength([1, 2, 3]); // array --> length .,,,,logLength(10); number --> X
